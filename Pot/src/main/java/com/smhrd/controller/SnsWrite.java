...
public class SnsWrite extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // 업로드된 이미지들을 쉼표로 연결, 선택된 파일이 없으면 sns_img는 null로 설정
            String sns_img = imgList.isEmpty() ? null : String.join(",", imgList);
            System.out.println("Uploaded Images: " + sns_img);

            // PotSns 객체 생성 및 데이터베이스 저장
