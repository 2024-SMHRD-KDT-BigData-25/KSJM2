...
<body>
	...
	<div class="container">
		...
		<div class="post-meta">
			<span>작성자: <%=board.getUser_id() %></span> | <span>작성일: <%=board.getCreated_at() %></span>
		...
		<div class="like-section">
			<button id="likeButton" class="like-button">
				<i class="fa-solid fa-seedling"></i></i> <span id="likeCount"><%=board.getSns_likes() %></span>
			</button>
		</div>
